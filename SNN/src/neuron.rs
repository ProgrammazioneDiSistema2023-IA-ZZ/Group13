...
struct Neuron {
    ...
    v_reset: f64,
    connections_same_layer: Vec<Connection>,
    connections_prec_layer: Vec<Connection>
}

impl Neuron{

    pub fn new(id:i32, v_threshold:f64, v_rest:f64, v_mem:f64, v_reset:f64, connections_same_layer: Vec<Connection>,connections_prec_layer: Vec<Connection>) -> Self{
        Neuron {
            id,
            v_rest,
            v_threshold,
